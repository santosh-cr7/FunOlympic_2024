...
if (mysqli_num_rows($result) > 0) {
    ...
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        $image = $row['image'];
?>
        <section class="p-5 flex-col items-center justify-center">
            <a href="#" class="flex mt-4 flex-col items-center bg-white border border-gray-200 rounded-lg shadow-md md:flex-row md:max-w-9xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
                ...
                <div class="flex flex-col justify-between p-4 leading-normal">
                    ...
                    <p class="mb-3 font-normal text-gray-700 dark:text-gray-400"><?php echo $content; ?></p>
                </div>
            </a>
        </section>
<?php
