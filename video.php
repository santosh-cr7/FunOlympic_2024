...
<body class="bg-gray-100">
    ...
    <!-- Video content -->
    <section class="video p-5 flex flex-col lg:flex-row justify-start lg:justify-between items-center">
        <!-- Video player -->
        <div class="w-full lg:w-3/4">
            <iframe class="w-full h-96 lg:h-128 border border-gray-200 rounded-lg mb-8" controls src="https://www.youtube.com/embed/UQ1du6isZ7c" title="Day 1 court 1 Asian Olympic Qualification Tournament" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
            
            <div class="p-4 w-screen overflow-x-hidden bg-gray-800 text-white rounded-lg mb-8">
        ...
        <div class="w-full mb-52 h-96 lg:w-1/4 bg-gray-800 text-white rounded-lg">
            <h2 class="text-lg font-semibold mb-2">Live Comment Box</h2>
            <textarea class="w-full h-80 bg-gray-900 text-white p-2 rounded-md resize-none" placeholder="Type your comment here..."></textarea>
        </div>
    </section>
