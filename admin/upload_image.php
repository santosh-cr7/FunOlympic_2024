        ...
        <div class="p-4 border-2 border-gray-200 border-solid rounded-lg dark:border-gray-700">
            <div class="flex justify-center items-center min-h-screen bg-gray-100">
                <div class="bg-white rounded-lg shadow-lg p-8 max-w-md w-full space-y-6">
                    <h1 class="text-3xl font-bold text-center text-gray-800">Upload Image</h1>
                    <form action="" method="post" enctype="multipart/form-data">
                        <div class="relative">
                            ...
                            <label for="image" class="flex items-center justify-center w-full py-2 px-4 bg-blue-500 text-white rounded-lg cursor-pointer hover:bg-blue-600 transition duration-300 ease-in-out">
                                <span class="mr-2"><i class="bi bi-cloud-upload"></i></span>
                                Select Image
                            </label>
                        </div>
                        <div id="selected-image" class="text-center text-gray-600"></div>
                        <button type="submit" name="submit" class="w-full my-3 py-2 px-4 bg-green-500 text-white rounded-lg hover:bg-green-600 transition duration-300 ease-in-out">Upload</button>
                    </form>
