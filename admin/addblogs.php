        ...
        <div class="p-4 border-2 border-gray-200 border-solid rounded-lg dark:border-gray-700">
            <div class="flex justify-center items-center min-h-screen bg-gray-100">
                <div class="bg-white rounded-lg shadow-lg p-8 max-w-md w-full space-y-6">
                    <h1 class="text-3xl font-bold text-center text-gray-800">Add New Post</h1>
                    <form action="" method="post" enctype="multipart/form-data" class="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="file" name="image" id="image" class="mt-1 focus:outline-none focus:ring focus:ring-blue-400 focus:border-blue-500">
                        </div>
                        <div class="flex justify-end space-x-4">
                            <button type="submit" name="submit" class="inline-flex items-center justify-center px-4 py-2 text-white bg-blue-500 rounded-md hover:bg-blue-600 focus:outline-none focus:ring focus:ring-blue-400 focus:ring-opacity-50">Upload</button>
                            <button type="reset" name="reset" class="inline-flex items-center justify-center px-4 py-2 text-white bg-red-500 rounded-md hover:bg-red-600 focus:outline-none focus:ring focus:ring-red-400 focus:ring-opacity-50">Cancel</button>
                        </div>
                    </form>
                    <div class="text-center">
                        ...
                        if (isset($_POST["submit"])) {
                            ...
                            if ($title == "" || $content == "" || $image_name == "") {
                                ...
                                if ($run) {
                                    echo "<p class='text-green-500'>Uploaded successfully!</p>";
                                } else {
