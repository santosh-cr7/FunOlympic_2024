        ...
        <div class="p-4 border-2 border-gray-200 border-solid rounded-lg dark:border-gray-700">
                ...
                <div class="flex justify-center items-center min-h-screen bg-gray-100">
                    <div class="bg-white rounded-lg shadow-lg p-8 max-w-md w-full space-y-6">
                        <h1 class="text-3xl font-bold text-center text-gray-800">Upload Video</h1>
                        <form action="" method="post" enctype="multipart/form-data">
                            <div class="relative">
                                ...
                                <label for="video" class="flex items-center justify-center w-full py-2 px-4 bg-blue-500 text-white rounded-lg cursor-pointer hover:bg-blue-600 transition duration-300 ease-in-out">
