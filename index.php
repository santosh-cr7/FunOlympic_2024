...
<body>
    ...
    <section class="mt-20">
        ...
        <div id="default-carousel" class="relative w-full h-screen" data-carousel="slide">
            <!-- Carousel wrapper -->
            <div class="relative h-[88%] overflow-hidden rounded-lg ">
                <!-- Item 1 -->
                ...
                <!-- Item 4 -->
                <div class="hidden duration-700 ease-in-out" data-carousel-item>
                    <img class="w-[100%]" src="assets/images/slide4.png" alt="...">
                </div>
    ...
    <section class="bg-white dark:bg-gray-900 bg-[url('https://flowbite.s3.amazonaws.com/docs/jumbotron/hero-pattern.svg')] dark:bg-[url('https://flowbite.s3.amazonaws.com/docs/jumbotron/hero-pattern-dark.svg')]">
        <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 z-10 relative">
            <a href="about.php" class="inline-flex justify-between items-center py-1 px-1 pe-4 mb-7 text-sm text-blue-700 bg-blue-100 rounded-full dark:bg-blue-900 dark:text-blue-300 hover:bg-blue-200 dark:hover:bg-blue-800">
                <span class="text-xs bg-blue-600 rounded-full text-white px-4 py-1.5 me-3">New</span> <span class="text-sm font-medium">Fun Olympic paris 2024! See what's here</span>
                <svg class="w-2.5 h-2.5 ms-2 rtl:rotate-180" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 6 10">
                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 9 4-4-4-4" />
                </svg>
            </a>
            <h1 class="mb-4 text-4xl font-extrabold tracking-tight leading-none text-gray-900 md:text-5xl lg:text-6xl dark:text-white">We invest in the world’s potential</h1>
            <p class="mb-8 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 lg:px-48 dark:text-gray-200">Here at Fun Olympic Paris 2024, we focus on markets where technology, innovation, and capital can unlock long-term value and drive economic growth.</p>


            <a href="login.php">
                <button class="text-white  w-48 max-w-md mx-auto     bg-blue-100 hover:bg-blue-200 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-lg px-4 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Get Started</button>
            </a>
        </div>
    ...
    <section class=" mt-8 bg-center bg-no-repeat bg-[url('https://flowbite.s3.amazonaws.com/docs/jumbotron/conference.jpg')] bg-gray-700 bg-blend-multiply">
        <div class="px-2 mx-auto max-w-screen-xl max-h-screen-xl text-center py-24 lg:py-20">
            <h1 class="mb-4 text-4xl font-extrabold tracking-tight leading-none text-white md:text-5xl lg:text-6xl">Explore Olympic Games</h1>
            ...
            <div class=" mt-6 h-full games flex flex-row gap-10 overflow-x-auto pb-4" style="-ms-overflow-style: none; scrollbar-width:3px;">
                ...
                <div class="bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 ">
                    ...
                    <div class="p-5 w-96">
                        <a href="#">
                            <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Archery olympic paris 2024</h5>
                        </a>
                        <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">Discover the anticipation and excitement surrounding archery at the Paris 2024 Olympic Games, where precision meets athleticism in a showcase of skill and determination.</p>
                ...
                <div class="bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 ">
                    ...
                    <div class="p-5 w-96">
                        <a href="#">
                            <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Badmintion olympic paris 2024</h5>
                        </a>
                        <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">Experience the speed and agility of badminton at the Paris 2024 Olympic Games, where players from around the world compete in fast-paced matches filled with skill and strategy.</p>
                ...
                <div class="bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 ">
                    ...
                    <div class="p-5 w-96">
                        <a href="#">
                            <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Basketball olympic paris 2024</h5>
                        </a>
                        <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">Witness the thrill of basketball at the Paris 2024 Olympic Games, where athletes showcase their talent and teamwork in intense matches that captivate fans worldwide.</p>
                ...
                <div class="bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 ">
                    ...
                    <div class="p-5 w-96">
                        <a href="#">
                            <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Fencing olympic paris 2024</h5>
                        </a>
                        <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">Experience the grace and precision of fencing at the Paris 2024 Olympic Games, where competitors engage in strategic duels of skill and agility.</p>
                ...
                <div class="bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 ">
                    ...
                    <div class="p-5 w-96">
                        <a href="#">
                            <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Taekwondo olympic paris 2024</h5>
                        </a>
                        <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">Feel the power and discipline of taekwondo at the Paris 2024 Olympic Games, where athletes demonstrate strength, technique, and respect in exhilarating bouts.<< /p>
                ...
                <div class="bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 ">
                    ...
                    <div class="p-5 w-96">
                        <a href="#">
                            <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Swimming olympic paris 2024</h5>
                        </a>
                        <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">Dive into the excitement of swimming at the Paris 2024 Olympic Games, where world-class athletes push the limits in the water, striving for glory with each stroke.</p>
                ...
                <div class="bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 ">
                    ...
                    <div class="p-5 w-96">
                        <a href="#">
                            <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Table Tennis olympic paris 2024</h5>
                        </a>
                        <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">Experience the speed and skill of table tennis at the Paris 2024 Olympic Games, where players showcase lightning-fast reflexes and precision in thrilling matches.</p>
